            ...
            <div className="text-center space-y-4">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  ...
                  className="bubble-button disabled:opacity-50 disabled:cursor-not-allowed text-lg px-6 py-4"
                >
                ...
                <button
                  ...
                  disabled={status === 'loading' || inputs.context.length === 0}
                  className="bubble-button bg-purple-500 hover:bg-purple-600 disabled:opacity-50 disabled:cursor-not-allowed text-lg px-6 py-4"
                >
