      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-primary-500 rounded-xl">
              <Sparkles className="w-4 h-4 sm:w-6 sm:h-6 text-white" />
            </div>
            <div className="hidden sm:block">
              <h1 className="text-lg sm:text-xl font-display font-semibold text-surface-900 dark:text-surface-100">
          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            ...
            <button
              onClick={toggleSound}
              className="p-1.5 sm:p-2 rounded-lg text-surface-600 dark:text-surface-400 hover:text-surface-900 dark:hover:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700 transition-colors duration-200"
          ...
          <nav className="flex space-x-1">
            {navItems.map((item) => (
              <NavLink
                ...
                to={item.path}
                className={({ isActive }) =>
                  `flex-1 text-center px-2 py-2 rounded-lg text-xs font-medium transition-colors duration-200 ${
                    isActive
                      ? 'bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300'
                      : 'text-surface-600 dark:text-surface-400 hover:text-surface-900 dark:hover:text-surface-100 hover:bg-surface-100 dark:hover:bg-surface-700'
                  }`
